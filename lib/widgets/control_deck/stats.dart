                    ...
                    children: List.generate(
                        ...
                        (index) => _InfoBar(
                              ...
                              value: _PlusMinus(
                                  increment: () {
                                    try {
                                      player.increaseStat(player.statsList[index]);
                                    } catch (e) {
                                  ...
                                  decrement: () {
                                    try {
                                      player.decreaseStat(player.statsList[index]);
                                    } catch (e) {
                                      Utility.showToast(e.toString());
                                    }
                                  },
                                  value: player.statValue(player.statsList[index])),
                            )),
                  ),
                ),
              ),
...
class _PlusMinus extends StatelessWidget {
  ...
  const _PlusMinus({required this.decrement, required this.increment, required this.value});
