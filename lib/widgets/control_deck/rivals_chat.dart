...
class _ChatOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _possibleActions = _gameData.possibleActions(_gameData.relationBetweenRulers(_currentPlayer.ruler, rival)!);
    return Expanded(
      flex: 2,
      child: Container(
                ...
                Visibility(
                  ...
                  child: SizedBox(
                    ...
                    child: Row(children: [
                      ...
                      _RelationStatusBox(
                        relation: _gameData.relationBetweenRulers(_currentPlayer.ruler, rival)!,
                      ),
                    ]),
                  ),
                ),
                              ...
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  final _response = _gameData.interactWithRival(
                                      A: _currentPlayer.ruler, B: rival, action: _possibleActions[index]);
                                  Provider.of<_RivalResponseProvider>(context, listen: false).updateResponse(_response);
                                },
                                child: Text(
...
class _RelationStatusBox extends StatelessWidget {
  const _RelationStatusBox({Key? key, required this.relation}) : super(key: key);
  ...
  @override
  Widget build(BuildContext context) {
    final _textStyle = Theme.of(context).textTheme.headline6!.copyWith(fontWeight: FontWeight.bold, color: _getColor());
                ...
                ? Column(
                    children: [
                      ...
                      Expanded(
                          child: Center(
                              child: FittedBox(
                        child: Text(describeEnum(relation).inCaps, style: _textStyle),
                      ))),
                    ],
                  )
                : FittedBox(
