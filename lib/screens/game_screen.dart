          ...
          children: [
            ConstrainedBox(
                constraints: BoxConstraints(
                    ...
                    maxWidth: MediaQuery.of(context).size.width - MediaQuery.of(context).viewPadding.right),
                child: StatsBar()),
            ConstrainedBox(
              constraints: BoxConstraints(
...
class __NextTurnFABState extends State<_NextTurnFAB> with TickerProviderStateMixin {
            ...
            onTap: () async {
              ...
              if (_game.lostGame) {
                ...
                if (oncomingAttack != null) {
                  ...
                  await Navigator.of(context).pushNamed(AttackScreen.route, arguments: {
                    'planet': oncomingAttack['planet'],
                    'attacker': _game.playerFromRuler(oncomingAttack['ruler']! as Ruler),
                  });
                } else {
