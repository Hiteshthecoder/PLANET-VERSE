...
import 'package:planet_verse/screens/character_selection_screen.dart';
import 'package:planet_verse/utility/constants.dart';
import 'package:sizer/sizer.dart';
import 'package:planet_verse/utility/instructions.dart';
import 'package:planet_verse/widgets/static_stars_bg.dart';
  ...
  Widget build(BuildContext context) {
        ...
        IconButton(
            onPressed: () async {
              try {
                ...
                debugPrint("cannot launch github link");
              } catch (e) {
        ...
        child: Center(
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacementNamed(context, CharacterSelectionScreen.route);
              },
        ...
        child: Stack(
          children: [
            Row(
              ...
              children: [
                Text('Instructions', style: Theme.of(context).textTheme.headline4!.copyWith(fontFamily: 'Italianno')),
              ],
            ),
            Positioned(
              top: 0,
    ...
    Widget _welcomeCard(orientation) {
      return Container(
        ...
        decoration: BoxDecoration(color: Colors.black26, borderRadius: BorderRadius.circular(16.sp)),
        child: Column(
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.bodyText2!.copyWith(fontWeight: FontWeight.w600, fontSize: 14.sp),
                ),
              ),
            )
          ],
    ...
    Widget _instructionMenu(Orientation orientation) {
      return Align(
        alignment: orientation == Orientation.landscape ? Alignment.bottomCenter : Alignment.center,
        child: CarouselSlider.builder(
            ...
            itemBuilder: (BuildContext context, int index, _) {
              if (index == 0) {
                ...
                return _instructionCard(List<String>.from(kInstructionsData.keys)[index - 1]);
              }
            }),
      );
    }
