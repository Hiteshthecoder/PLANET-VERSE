            ...
            TextButton(
                onPressed: () {
                  if (_gameData.currentPlayer.ruler == attacker.ruler) {
                    ...
                    _gameData.changeOwnerOfPlanet(newRuler: attacker.ruler, planetName: planet.name);
          ...
          children: [
            ...
            MultiProvider(
              providers: [
                ...
                Provider<bool>.value(value: _gameData.currentPlayer.ruler == attacker.ruler),
                ...
                ChangeNotifierProvider<FormationProvider>.value(value: _formationProvider)
              ],
