          ...
          return MaterialApp(
            ...
            theme: ThemeData.dark().copyWith(
              ...
              textTheme: TextTheme(
                ...
                button: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.bold, color: Colors.white),
              ),
              ...
              elevatedButtonTheme: ElevatedButtonThemeData(
                style: ButtonStyle(
                  ...
                  backgroundColor: MaterialStateProperty.all<Color>(Palette.deepBlue),
            ...
            routes: {
              ...
              CharacterSelectionScreen.route: (ctx) => CharacterSelectionScreen(),
            ...
            onGenerateRoute: (routeSettings) {
              if (routeSettings.name == InfoScreen.route) {
                return MaterialPageRoute(
                    builder: (context) => InfoScreen(characterSelected: routeSettings.arguments! as bool));
                ...
                return MaterialPageRoute(
                  builder: (context) => AttackScreen(attacker: _attacker, planet: _planet),
                );
              }
              return null;
            },
